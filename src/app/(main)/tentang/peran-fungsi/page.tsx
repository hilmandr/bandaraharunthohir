...
export default function PeranFungsi() {
  return (
    <>
        ...
        <div className=" flex flex-col w-full items-center justify-center pt-10">
          <div className=" flex flex-col w-full py-10 border-b">
            ...
            <ul className=" text-justify list-disc text-base leading-relaxed pl-5">
              ...
              <li>
                ...
                atau sebaliknya dalam bentuk interkoneksi antarmoda pada simpul
                transportasi yang ditetapkan dengan memperhatikan ketentuan
                sistem transportasi nasional;
              </li>
              <li>
                Pendorong dan penunjang kegiatan industri dan/atau perdagangan,
                dimaksudkan agar keberadaan Bandar Udara dapat memudahkan
                transportasi ke dan dari wilayah di sekitarnya dalam rangka
                ...
                serta keterpaduan dengan sektor pembangunan lainnya dan
                ditetapkan dengan memperhatikan ketentuan Rencana Pengembangan
                Ekonomi Nasional;
              </li>
              <li>
                ...
                karena sulitnya moda transportasi lain, penghubung daerah
                perbatasan dalam rangka mempertahankan wilayah Negara Kesatuan
                Republik Indonesia, serta kemudahan dalam penanganan bencana
                alam pada wilayah tertentu dan sekitarnya yang ditetapkan dengan
                memperhatikan ketentuan mengenai pembangunan daerah tertinggal,
                ketentuan di bidang pertahanan negara, ketentuan di bidang
                pengelolaan daerha perbatasan, dan ketentuan di bidang
          ...
          <div className=" flex flex-col w-full py-10">
            ...
            <p className=" text-base pt-2">
              ...
              merupakan tempat unit kerja instansi pemerintah dalam menjalankan
              tugas dan fungsinya terhadap masyarakat sesuai dengan ketentuan
